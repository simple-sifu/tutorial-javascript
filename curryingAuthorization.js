...
const authFactory1 = (callback) => (role) => (permission_name) =>
  callback(role, permission_name);
...
console.log(userAuth("change_password"));
console.log(visitorAuth("change_username"));
